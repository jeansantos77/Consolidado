...
Foi criado o microserviço Consolidado.API, este é responsável por expor endpoints como:
	...
	1. GET /Consolidado: mostra os lançamentos consolidados por data, contendo o saldo anterior, os créditos, os débitos e o saldo do dia. Para executar deve-se informar um intervalo de datas.
